...
bool StartGame(HWND Enter_Button, HWND Restart_Button, HWND UI_Panel, HWND Game_Panel, HWND checkboxes[amount_width*amount_height], Plansza* plansza, int blocks[], int ilosc) {
...
bool RestartGame(HWND Enter_Button, HWND Restart_Button, HWND UI_Panel, HWND Game_Panel, HWND checkboxes[amount_width * amount_height], Plansza* plansza) {
